    ...
    <div className="min-h-screen px-6 py-10 md:px-20 md:py-16">
      ...
      <div className="bg-white rounded-lg shadow-sm mb-8">
        ...
        <div className="grid md:grid-cols-[1fr_1.3fr] gap-8">
          ...
          {/* Vision Content */}
          <div className="text-primary-bgText space-y-4">
            ...
            <div className="space-y-3">
              <h3 className="font-bold text-primary-bgText">Indikator Visi:</h3>
      ...
      <div className="bg-white rounded-lg shadow-sm">
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <div className="w-32 h-1 bg-secondary-hover mx-auto mb-4"></div>
          </div>
          ...
          <div className="grid md:grid-cols-[1fr_1.3fr] gap-8">
            ...
            <div className="text-primary-bgText space-y-4">
              <p className="text-justify mb-6">
                ...
                244 Jakarta yang dirumuskan berdasarkan visi adalah sebagai
                berikut:
              </p>
      ...
      <div className="bg-white rounded-lg shadow-sm">
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <div className="w-28 h-1 bg-secondary-hover mx-auto mb-4"></div>
          </div>
...
//           <h2 className="text-3xl font-bold text-primary-bgText mb-8">
//             VISI SEKOLAH
//           </h2>
...
//         <div className="p-8">
//           <div className="text-center mb-8">
//             <h2 className="text-3xl font-bold text-primary-bgText">MISI SEKOLAH</h2>
//             <div className="w-16 h-1 bg-yellow-500 mx-auto mt-4"></div>
//           </div>
...
//         <div className="p-8">
//           <div className="text-center mb-8">
//             <h2 className="text-3xl font-bold text-primary-bgText">TUJUAN </h2>
//             <div className="w-16 h-1 bg-yellow-500 mx-auto mt-4"></div>
//           </div>
//           <div className="flex items-center justify-center border h-[50%]">
//             <div className="bg-gray-200 rounded-lg w-full h-[30rem] overflow-hidden">
